...
public class AccountWithdrawalExample {
    ...
    public static void main(String[] args) {
        ...
        OpnxV3RestResponse<WithdrawV3Resp> accountWithdrawal = client.accountWithdrawal(withdrawV3Params);
        System.out.println(JSONObject.toJSONString(accountWithdrawal));
